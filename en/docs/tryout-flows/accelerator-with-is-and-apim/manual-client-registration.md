...
2. Go to Key Managers on the left main menu. Click on **Add Key Manager** button.
    ![add-key-manager](en/docs/assets/img/learn/mcr/custom-km/add-key-manager.png)

3. Enter a Name and Display Name, and select **fsKeyManager** as the Key Manager Type.
    ![key-manager-basic-details](en/docs/assets/img/learn/mcr/custom-km/key-manager-basic-details.png)
...
9. Enable the Role creation is WSO2 Identity Server 7 as by ticking as below.
    ![enable-role-validation](en/docs/assets/img/learn/mcr/custom-km/enable-role-validation.png)

10. Set **Key Manager Permission** to **Public**.
    ![km-permisiion](en/docs/assets/img/learn/mcr/custom-km/km-permisiion.png)
...
13. Disable the Resident Key Manager.
    ![km-display](en/docs/assets/img/learn/mcr/custom-km/km-display.png)
