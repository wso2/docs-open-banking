...
5. At the bottom of the page, a list of bank accounts that the TPP wishes to access is displayed.

6. Select one or more accounts from the list and click **Confirm**. <br/> 
![confirm_consent](../../assets/img/try-out/cof-consent.png)  
