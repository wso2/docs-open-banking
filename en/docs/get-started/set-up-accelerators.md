...
1. Download the sample [Banking backend](../assets/attachments/api#fs#backend.war.zip), extract the zip file and place the api#fs#backend.war inside `<APIM_HOME>/repository/deployment/server/webapps` folder.
